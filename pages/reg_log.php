...
<div class="wrappers" id="loginbox">
  ...
  <div class="title-text">
    ...
    <div class="field">
                  <input type="password" name="loginpassword" id="log_password" placeholder="Password" required>
                  <span class="eye"><i class="fas fa-eye" id="toggle" onclick="showLogPassword()"></i></span>
                </div>
    <div class="pass-link">
    <a href="javascript:void(0);" id="forget" onclick="ShowForgetPopUp()">Forgot password?</a></div>
    <div class="field btn">
                  <div class="btn-layer">
    </div>
    ...
    <div class="field">
                  ...
                  <span class="eye"><i class="fas fa-eye" id="toggler" onclick="showRegPassword()"></i></span>
                </div>
    <div class="field">
        ...
        $inserts="INSERT INTO users(user_name, user_phone_number, user_email, user_password, user_confirm_password) VALUES ('$name','$phone','$email','$pass','$con_pass')";
         ...
         if ($query) {
                  ...
                  $_SESSION['customer_email']=$email;
                    ...
                    echo '<script>swal("Great!", "You have Not Successfully Registerd!", "error").then(function() {
              ...
              $body = '<b>Name:</b>'.$name.'<br><b>Email:</b>'.$email.'<br><b>Contact Number:</b>'.$phone.'<br><br>'.$name . ' Registred Successfully.';
...
function validatePassword()
{
    ...
    {
        password.setCustomValidity("Passwords must be 8 Digit");
    } 
